      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Global Stablecoin Accounts are next-generation digital accounts built for modern businesses. They combine the global reach of stablecoins with the usability of traditional accounts"
            index={0}
          />
          <FeatureCard
            ...
            title="Pay-ins"
            description="Fund your account or collect customer payments. Fluida simplifies global capital flow into your business, whether you're topping up for outbound transfers or accepting payments at scale."
            index={1}
          />
          <FeatureCard
            ...
            title="Payouts"
            description="Withdraw, convert, or pay anyone—anywhere—with real-time, multi-currency payouts powered by your Global Stablecoin Account."
            index={2}
          />
          <FeatureCard
            ...
            title="Invoicing"
            description="Create and send professional invoices in minutes with Fluida's invoicing tools. Customize with your branding, select from multiple currencies (including USDC), and track payments in real time. Automatic reconciliation and flexible payment options make global billing effortless and efficient."
            index={3}
          />
          <FeatureCard
            ...
            description="Store and organize your USD, EUR, or digital assets in Fluida's virtual accounts. Enjoy bank-grade security, easy conversions to local currencies, and seamless integration with your bank via Plaid or manual linking. It's a powerful way to manage funds with real-time visibility."
            index={4}
          />
          <FeatureCard
            ...
            title="Credit Cards"
            description="The Fluida Corporate Card is designed for modern businesses operating globally. Linked directly to your company's USDC balance, it allows instant, low-cost spending in multiple currencies."
            index={5}
          />
        </div>
      </div>
